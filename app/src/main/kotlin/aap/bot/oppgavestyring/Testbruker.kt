...
enum class Testbruker(val epost: String, val ident: String) {
    VEILEDER_GAMLEOSLO_NAVKONTOR("f_Z994559.e_Z994559@trygdeetaten.no", "Z994559"),
    SAKSBEHANDLER("f_Z994554.e_Z994554@trygdeetaten.no", "Z994554"),
    SAKSBEHANDLER_STRENGT_FORTROLIG("f_Z994553.e_Z994553@trygdeetaten.no", "Z994553"),
    FATTER("f_Z994439.e_Z994439@trygdeetaten.no", "Z994439"),
    BESLUTTER("f_Z994524.e_Z994524@trygdeetaten.no", "Z994524"),
